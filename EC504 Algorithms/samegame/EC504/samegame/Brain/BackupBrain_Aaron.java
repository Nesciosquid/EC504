...
public class BackupBrain_Aaron extends EC504.samegame.Brain.Brain {
	// fields
	 ...
	 */
	public BackupBrain_Aaron(GUI myGUI) {
		super(myGUI);
	}
	...
	private Pos chooseClusterMove() {
		...
		int end = sb.columns() -60; // change to alter distance from end to search for good clusters
		if (end < 0) {
			end = 0;
		}
